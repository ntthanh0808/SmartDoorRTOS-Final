...
if __name__ == "__main__":
    ...
    if not os.path.exists(dataset_path):
        ...
        print("📝 Hướng dẫn:")
        print("   1. Tạo thư mục 'dataset' và thêm ảnh theo cấu trúc:")
        print("      dataset/")
        print("      ├── Nguyen_Van_A/")
        print("      │   ├── img1.jpg")
        print("      │   └── img2.jpg")
    ...
    # Load dataset
    train_dataset = FaceCropDataset(dataset_path, transform=transform)
    
    if len(train_dataset) == 0:
        print("❌ Dataset trống! Vui lòng thêm ảnh vào thư mục 'dataset'")
        exit(1)
    ...
    print(f"✅ Dataset loaded: {num_classes} người, {len(train_dataset)} ảnh.")
